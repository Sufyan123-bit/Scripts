...
local function runMainScript()
    ...
    local Games = loadstring(game:HttpGet("https://raw.githubusercontent.com/mafiosowow/c00lguiV6rebornBySpookzWasHereAndOfficialMafioso/refs/heads/main/SpookzWasHereOnTop"))()
